...
# Initialize the OCR reader with English and Russian language support
reader = easyocr.Reader(['en', 'ru'], gpu=False)

# Mapping dictionaries for character conversion
dict_char_to_int = {'А': '4',
                    'B': '8',
                    'В': '8',
                    'Е': 'E',
                    'К': 'K',
...
def format_license(text):
    ...
    mapping = {0: dict_int_to_char, 4: dict_int_to_char, 5: dict_int_to_char,
               1: dict_char_to_int, 2: dict_char_to_int, 3: dict_char_to_int, 6: dict_char_to_int, 7: dict_char_to_int, 8: dict_char_to_int}
